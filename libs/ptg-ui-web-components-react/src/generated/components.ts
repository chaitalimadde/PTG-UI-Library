...
import type { JSX } from '@ptg-ui/ptg-ui-web-components';
...
export const PtgInput = /*@__PURE__*/createReactComponent<JSX.PtgInput, HTMLPtgInputElement>('ptg-input');
export const PtgModal = /*@__PURE__*/createReactComponent<JSX.PtgModal, HTMLPtgModalElement>('ptg-modal');
export const PtgPagination = /*@__PURE__*/createReactComponent<JSX.PtgPagination, HTMLPtgPaginationElement>('ptg-pagination');
export const PtgRadiobtn = /*@__PURE__*/createReactComponent<JSX.PtgRadiobtn, HTMLPtgRadiobtnElement>('ptg-radiobtn');
export const PtgRadiobuton = /*@__PURE__*/createReactComponent<JSX.PtgRadiobuton, HTMLPtgRadiobutonElement>('ptg-radiobuton');
export const PtgSelect = /*@__PURE__*/createReactComponent<JSX.PtgSelect, HTMLPtgSelectElement>('ptg-select');
export const PtgSidenav = /*@__PURE__*/createReactComponent<JSX.PtgSidenav, HTMLPtgSidenavElement>('ptg-sidenav');
export const PtgSpinner = /*@__PURE__*/createReactComponent<JSX.PtgSpinner, HTMLPtgSpinnerElement>('ptg-spinner');
...
export const PtgTooltip = /*@__PURE__*/createReactComponent<JSX.PtgTooltip, HTMLPtgTooltipElement>('ptg-tooltip');
